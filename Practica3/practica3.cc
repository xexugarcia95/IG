...
void normal_keys(unsigned char Tecla1,int x,int y)  {
	...
	if (salir) {
		...
		switch (toupper(Tecla1)) {
		    ...
		    case '5': escena->setMode(5); cout << "Modo Sólido y Alambre\n"; break;
		    case 'Z': escena->rotacion(); cout << "Rotación\n"; break;
		    case 'X': escena->rotacion_inversa(); cout << "Rotación inversa\n"; break;
		    case 'C': escena->moverA(); cout << "Moviendo el primer cajón\n"; break;
		    case 'V': escena->retrocesoA(); cout << "Retrocede primer cajón\n"; break;
		    case 'B': escena->moverB(); cout << "Moviendo el segundo cajón\n"; break;
		    case 'N': escena->retrocesoB(); cout << "Retrocede el segundo cajón\n"; break;
		    case '8': escena->masPuerta(); cout << "Aumenta tamaño puerta\n"; break;
		    case '9': escena->menosPuerta(); cout << "Disminuye tamaño puerta\n"; break;
		    ...
		    case '4': escena->setType(4); cout << "Cubo provisional\n"; break;
